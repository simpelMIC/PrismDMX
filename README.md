...
1. **Clone the Repository**: Clone the PrismDMX repository to your local machine using the following command:
```
git clone https://github.com/simpelMIC/PrismDMX.git
```
